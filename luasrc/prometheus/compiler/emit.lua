...
return function(Compiler)
    ...
    function Compiler:emitContainerFuncBody()
        ...
        for i, block in ipairs(self.blocks) do
            ...
            -- NOTE: original Prometheus also did `blocks[id] = block;` here, but the
            -- entry is never read and on gopher-lua a numeric `id` can be promoted
            -- into the array portion of the table, leaving holes that confuse
            -- table.sort below. Patch by prometheus-lua-go.
        end
